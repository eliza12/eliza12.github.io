...
{
	/*let OS = navigator.userAgent.match(/windows nt [\d.]+/gi);
	if(OS){		let vers = OS[0].match(/[\d.]+/) * 1;
...
EditorContent.push("	+ Custom letiable tagging (like VS 08)  ");
...
// EditorContent.push("//       Alleto (XML-language, Tagmatcher)         |");
...
// EditorContent.push("{");
// EditorContent.push("	let a1 = this.slice(0,index);");
// EditorContent.push("	let a2 = this.slice(index, this.length);");
...
// EditorContent.push("	for(let i=0, B; B=this[i]; i++)");
// EditorContent.push("		if(B[1]==T)");
// EditorContent.push("			return new Array(i,B[1]);");
// EditorContent.push("	return false;");
// EditorContent.push("};");
// EditorContent.push("");
// EditorContent.push("let writeroot;");
// EditorContent.push("let keylog = new Array();");
// EditorContent.push("let hasFocus = false;");
// EditorContent.push("let Curser");
// EditorContent.push("let Editor");
// EditorContent.push("let Selection");
// EditorContent.push("//placement of editor");
// EditorContent.push("let editor_x = 50");
// EditorContent.push("let editor_y = 50");
// EditorContent.push("let cols = 60;");
// EditorContent.push("let rows = 30;");
// EditorContent.push("");
...
// EditorContent.push("	let delta = 0;");
...
// EditorContent.push("	let targ;");
// EditorContent.push("	//if (!e) let e = window.event;");
...
// EditorContent.push("		for(let x=0;x<6;x++)");
...
// EditorContent.push("	let evt = e || window.event;");
// EditorContent.push("	");
...
// EditorContent.push("	let e = evt || window.event;");
...
// EditorContent.push("}");
// EditorContent.push("");
// EditorContent.push("let isPressed = false");
// EditorContent.push("function mousedownEvtHandler(evt){ ");
// EditorContent.push("	let e = evt || window.event;");
// EditorContent.push("	isPressed = true;");
// EditorContent.push("	");
// EditorContent.push("	let coord = Curser.getMousePos([");
// EditorContent.push("		e.clientX - editor_x + window.pageXOffset +5, ");
// EditorContent.push("		e.clientY - editor_y + window.pageYOffset +9");
// EditorContent.push("	]);");
// EditorContent.push("	");
...
// EditorContent.push("let, address    { font-style: italic }")
...
// EditorContent.push("{");
// EditorContent.push("	let bbb = 123;");
// EditorContent.push("	let ping,pong;");
// EditorContent.push("	let a=2,b=3;");
// EditorContent.push("	");
// EditorContent.push("	for(let i=0; i<10; i++)");
// EditorContent.push("	{");
// EditorContent.push("		");
// EditorContent.push("	}");
// EditorContent.push("}");
